...
-- from core_playlist, core_playlist_song, core_song, core_language
-- where core_playlist.id = core_playlist_song.playlist_id
-- and core_song.id = core_playlist_song.song_id 
-- and core_song.language_id = core_language.id
...
-- from core_playlist, core_playlist_song, core_song, core_genre, core_song_artist, core_artist
-- where core_playlist.id = core_playlist_song.playlist_id
-- and core_playlist_song.song_id = core_song.id  
-- and core_genre.id = core_song.genre_id and core_genre.id = 17
-- and core_song.id = core_song_artist.song_id 
-- and core_song_artist.artist_id = core_artist.id and core_artist.id = 70 ;
...
-- from core_song, core_genre, core_song_artist, core_artist
-- where core_genre.id = core_song.genre_id and core_song.genre_id = 17  
-- and core_song.id = core_song_artist.song_id
...
-- select core_artist.id as "Artist ID", core_artist.name as "Artist Name", count(core_song_artist.song_id) from core_artist
-- inner join core_song_artist on core_song_artist.artist_id = core_artist.id group by 
-- (core_artist.id);
...
-- from core_song, core_song_artist, core_artist, core_playlist_song, core_playlist
-- WHERE core_song.id = core_song_artist.song_id
-- AND core_artist.id = core_song_artist.artist_id
-- AND core_song.id = core_playlist_song.id
-- AND core_playlist_song.playlist_id = core_playlist.id order by (core_playlist.id);
...
-- FROM core_playlist, core_playlist_song, core_song, core_song_artist, core_artist
-- WHERE core_playlist.id = core_playlist_song.playlist_id
-- AND core_playlist_song.song_id = core_song.id
-- AND core_song.id = core_song_artist.song_id
-- AND core_song_artist.artist_id = core_artist.id 
...
-- from core_playlist, core_playlist_song, core_song, core_song_artist, core_artist
-- WHERE core_playlist_song.playlist_id = core_playlist.id
-- AND core_song.id = core_playlist_song.song_id
-- AND core_song.id = core_song_artist.song_id
-- AND core_artist.id = core_song_artist.artist_id;
...
from core_playlist, core_playlist_song, core_song_artist
where core_playlist.id = core_playlist_song.playlist_id 
and core_playlist_song.song_id = core_song_artist.song_id
...
-- from core_playlist, core_playlist_song, core_song, core_genre
-- where core_playlist.id = core_playlist_song.playlist_id 
-- and core_playlist_song.song_id = core_song.id
...
select core_playlist.id, core_playlist.name, core_song.name as "Total Songs", count(core_songlike.user_id) AS "Total Likes"
-- , core_songlike.user_id
FROM core_song, core_songlike, core_playlist, core_playlist_song
WHERE core_playlist_song.playlist_id = core_playlist.id
and core_playlist_song.song_id = core_song.id
and core_song.id = core_songlike.song_id
